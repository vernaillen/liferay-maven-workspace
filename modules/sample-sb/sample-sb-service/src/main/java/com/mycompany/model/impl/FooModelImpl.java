...
import com.mycompany.model.FooModel;
import com.mycompany.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.mycompany.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.mycompany.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.mycompany.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.mycompany.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.mycompany.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.mycompany.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.mycompany.service.util.ServiceProps.get(
				"lock.expiration.time.com.mycompany.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.mycompany.model.Foo");
